...
python run_vllm.py --model Qwen/Qwen3-Coder-30B-A3B-Instruct --result_save_name code_translation_eval_Qwen3.jsonl --log_file_name code_translation_eval_Qwen3.log --use_sft_prompt_template
